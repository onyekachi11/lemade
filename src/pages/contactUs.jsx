        ...
        <div className="flex flex-col gap-3 text-[12px] items-start mt-4 px-7" >
          <a href="" className="flex gap-4 items-center">
            <div className="border rounded-full p-1" >
              <img src={Facebook} className=" bg-[#180123] rounded-full p-1" />
            </div>
            <p>Engage with us on Facebook</p>
          </a>
          <a href="" className="flex gap-4 items-center">
            <div className="border rounded-full p-1" >
              <img src={Whatsapp} className=" bg-[#180123] rounded-full p-1" />
            </div>
            <p>Hit us up and chat with us on Whatsapp</p>
          </a>
          <a href="" className="flex gap-4 items-center">
            <div className="border rounded-full p-1" >
              <img src={Instagram} className=" bg-[#180123] rounded-full p-1" />
            </div>
